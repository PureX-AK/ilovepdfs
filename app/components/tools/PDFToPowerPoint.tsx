...
export default function PDFToPowerPoint() {
  ...
  const handleSelectedFile = (file: File) => {
    ...
    setFiles('pdf-to-ppt', [file]);
    router.push('/pdf-to-ppt/files');
  };
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold text-[var(--color-text-dark)] mb-2">
                Upload your PDF to convert to PowerPoint
              </h3>
              <p className="text-[var(--color-text-muted)] mb-6">
                Drop your PDF here or click to browse. On the next step, you can review the file and start
                the conversion.
              </p>
              <label htmlFor="pdf-to-ppt-file-input" className="cursor-pointer">
