...
export default function CompressPDF() {
  ...
  const handleSelectFile = (file: File) => {
    ...
    // Store the file for the compress workflow and go to the files/options page
    ...
    <section className="py-12">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Info Box about the next step */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
            <p className="text-sm text-blue-800">
              <strong>Next step:</strong> After you upload your PDF, you&apos;ll be able to choose the
              compression level before we process your file.
            </p>
          </div>
        </div>
      </div>
