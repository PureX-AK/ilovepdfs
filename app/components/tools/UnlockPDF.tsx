...
export default function UnlockPDF() {
  ...
  const handleUnlock = async () => {
    if (!selectedFile) {
      showError('Please select a PDF file to unlock.');
      return;
    }

    const toastId = showLoading('Unlocking PDF...');
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setProgress(0);
        updateToSuccess(toastId, 'PDF unlocked successfully! Download started.');
      }, 500);
    } catch (error: any) {
      clearInterval(progressInterval);
      setIsProcessing(false);
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          {selectedFile && (
            <div className="bg-white rounded-xl shadow-sm border border-[var(--color-border-gray)] mb-8">
              <div className="p-6">
                <h3 className="text-lg font-semibold text-[var(--color-text-dark)] mb-4">Unlock Options</h3>
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter password (leave empty if not protected)"
